...
public class PlayerController : MonoBehaviour
{
    ...
    //okresl miejsca spawnowania pocisk�w
    ...
    void Update()
    {
        ...
        //teleportuj statek je�li wyjdzie z ekranu
        if(Mathf.Abs(transform.position.x) > cs.gameWidth / 2)
        {
            //wylecieli�my z ekranu w poziomie - teleportuj na druga strone
        ...
        {
            //wylecieli�my z ekranu w pionie - teleportuj na druga strone
